<template>
  <div class="thing-drawer-left-wrapper">
    ...
    <v-card class="thing-drawer-left-container top" flat>
      <v-treeview
        open-all
        :items="items"
        item-key="name"
    ...
    <!-- Bottom -->
    <!-- <v-row class="thing-drawer-left-container bottom pa-4">
...
<style>
.thing-drawer-left-wrapper {
  width: 100%;
  padding: 0px 4px;
  overflow: hidden;
}

.thing-drawer-left-wrapper .v-toolbar__content {
  padding: 0px;
}

.thing-drawer-left-container {
  width: 100%;
}
</style>
